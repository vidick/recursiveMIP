...
Let $V = (C_Q,C_A)$ be a verifier and let $\mathscr{Z}_V$ denote the simcom game corresponding to $V$. We say that $V$ accepts in $\mathscr{Z}_V$ if measuring the $\sO \sK_2 \sK_2'$ registers yields outcome $(o,k_2,k_2')$ where $o = 1$ and $k_2 = k_2'$. 
