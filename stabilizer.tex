...
\end{itemize} 
We argue that the success probability of this strategy in $G$ is polynomially related to the success probability of the strategy in $G'$, and more specifically to the success probability in part 2. of $G'$. \tnote{this is missing}
\end{proof}